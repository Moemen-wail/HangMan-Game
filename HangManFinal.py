...
icon = PhotoImage(file='photo/h6.png')
window.iconphoto(True, icon)
window.config(bg="#2C2C2C")


#----------------- This is the code for the word lists-----------------
IT_word_list = [
...
#--------------------- This is the code for the start button and the start screen---------------------
def start_game():
...
#---------------------- This is the code for choosing a category and starting the game---------------------
...
#--------------------- This is the code for the back to menu button---------------------
    def back_to_menu():
        global lives
        global hint
...
#---------------------- This is the code for updating the displayed word and checking win/lose conditions----------------------
    def update_word():
        global word_label
        global chosen_word
        global correct_letters
...
#----------------------- This is the code for disabling the letter buttons after game ends----------------------
    def disable_buttons():
        global buttonp
        global buttone
        global frame2
...
#--------------------- This is the photos of the hanger---------------------
...
#--------------------- This is the code for the play again button---------------------
def play_again():
    global lives
    global hint
    global correct_letters
    ...
    img_labelhow.place_forget()
    img_labelw.place_forget()
    img_labell.place_forget()   
    buttonp.place_forget()
